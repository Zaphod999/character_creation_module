...
def special(char_name: str, char_class: str) -> str:
    """Get special abilities points by class."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Choose class at the begining."""
    approve_choice: str = ''
    char_class: str = ''
    while approve_choice != 'y':
        char_class = input('Введи название персонажа, за которого хочешь игр'
                           'ать: Воитель — warrior, Маг — mage,'
                           ' Лекарь — healer: ')
        if char_class == 'warrior':
